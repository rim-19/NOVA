...
export function WhatsAppIcon() {
    ...
    return (
        <a
            ...
            className="fixed bottom-5 right-4 z-[90] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_22px_rgba(0,0,0,0.35),0_0_16px_rgba(37,211,102,0.3)] transition-transform hover:scale-105"
        >
